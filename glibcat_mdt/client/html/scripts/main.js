var obj = {
		'Wykroczenia drogowe':{
			...
			'Jazda pod wpływem alkoholu lub substancji odurzających': {
                ...
                'Jail min': 5,
                'Jail max': 15,
				'Additional': 'Odholowanie pojazdu do 3 dni, Konfiskata prawo jazdy na wszystkie kategorie',
            },
			...
			'Jazda pojazdem mechanicznym bez uprawnień': {
                'Ticket min': 7500,
                'Ticket max': 10000,
                'Jail min': 0,
                'Jail max': 0,
		...
		'Przestępstwa lekkie':{
			'Niszczenie mienia państwowego/prywatnego': {
                'Ticket min': 2000,
                'Ticket max': 10000,
                'Jail min': 0,
                'Jail max': 0,
			...
			'Gestykulacje obrażające funkcjonariusza': {
                'Ticket min': 10000,
                'Ticket max': 15000,
                'Jail min': 0,
                'Jail max': 5,
		...
		'Przestępstwa związane z bronią i nielegalnymi substancjami/przedmiotami':{
			'Posiadanie narkotyków miękkich': {
                'Ticket min': 5000,
                'Ticket max': 15000,
                'Jail min': 5,
                'Jail max': 10,
				'Additional': '(marihuana powyżej 25g/5 paczek)',
            },		
			'Posiadanie nielegalnych przedmiotów': {
                ...
                'Jail min': 10,
                'Jail max': 15,
				'Additional': 'wiertło, wytrych, kamizelka kuloodporna',
            },		
			'Posiadanie nielegalnych zwierząt': {
                'Ticket min': 10000,
                'Ticket max': 25000,
                'Jail min': 25,
                'Jail max': 45,
				'Additional': 'żółwie, rekiny, słonie, tygrysy, lwy',
            },
			'Posiadanie narkotyków twardych': {
                'Ticket min': 20000,
                'Ticket max': 30000,
                'Jail min': 10,
                'Jail max': 20,
				'Additional': '(metamfetamina/kokaina)',
            },
			'Handel narkotykami miękkimi': {
                'Ticket min': 20000,
                'Ticket max': 35000,
                'Jail min': 10,
                'Jail max': 20,
				'Additional': '(marihuana/jointy)',
            },
			'Handel narkotykami twardymi': {
                'Ticket min': 35000,
                'Ticket max': 50000,
                'Jail min': 30,
                'Jail max': 40,
			...
			'Posiadanie nielegalnej broni krótkiej': {
                'Ticket min': 20000,
                'Ticket max': 45000,
                'Jail min': 20,
                'Jail max': 40,
		...
		'Przestępstwa związane z użyciem siły/uszczerbkiem na zdrowiu':{
			...
			'Zabójstwo obywatela': {
                ...
                'Jail min': 40,
                'Jail max': 200,
				'Additional': 'Konfiskata licencji na broń i blacklista',
            },
			'Napaść na FP': {
                'Ticket min': 10000,
                'Ticket max': 20000,
			...
			'Naruszenie nietykalności cielesnej FP': {
                'Ticket min': 20000,
                'Ticket max': 35000,
                'Jail min': 20,
                'Jail max': 30,
		...
		if(v2['Ticket min'] != v2['Ticket max']){
			if(v2['Additional'] != '' && v2['Jail max'] != ''){
				if(v2['Jail max'] == v2['Jail min']){
					...
					punishments = punishments + "<u>Informacja</u>: " + v2['Additional'] + '<br>';
				} else {
					punishments = punishments + "Grzywna: " + "$" + v2['Ticket min'] + " - $" + v2['Ticket max'] + '<br>';
